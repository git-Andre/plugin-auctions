                            ...
                            .done( lastBidPrice => {
                                ...
                                // es gibt inzwischen schon ein höheres Gebot
                                    ...
                                    NotificationService.warn(
                                        "<h3>STATUS:</h3><hr>" + TranslationsAo.auctions.auctionIsHigherMaxBid )
                                        .close;
                                    this.reload( 2600 );
                                }
                            } )
                ...
                if ( this.auction.bidderList[this.auction.bidderList.length - 2].customerId === this.userdata.id ) {
                    switch ((this.auction.bidderList[this.auction.bidderList.length - 1].bidStatus).toString()) {
                        case AuctionConstants.OWN_BID_CHANGED: {
                            NotificationService.info(
                                "<h3>" + TranslationsAo.auctions.auctionlastAction + "</h3><hr>" +
                                TranslationsAo.auctions.auctionChangedOwnMaxBid )
                        ...
                        case AuctionConstants.LOWER_BID: {
                            ...
                            NotificationService.success(
                                "<h3>STATUS:</h3><hr>" + TranslationsAo.auctions.auctionLowerMaxBid )
                                .closeAfter( NOTIFY_TIME );
                            break;
                        }
                    }
                    ...
                    switch ((this.auction.bidderList[this.auction.bidderList.length - 1].bidStatus).toString()) {
                        case AuctionConstants.OWN_BID_CHANGED: {
                            ...
                            NotificationService.info(
                                "<h3>STATUS:</h3><hr>" + TranslationsAo.auctions.auctionChangedOwnMaxBid )
                                .closeAfter( NOTIFY_TIME );
                            break;
                        }
                        case AuctionConstants.HIGHEST_BID: {
                            NotificationService.success(
                                ...
                                "<h3>STATUS:</h3><hr>" + TranslationsAo.auctions.auctionYouHaveHighestBid )
                                .closeAfter( NOTIFY_TIME );
                            break;
                        }
                        case AuctionConstants.LOWER_BID: {
                ...
                ApiService.get( "/api/calctime/" + this.auction.startDate + "/" + this.auction.expiryDate )
                    .done( tensefromServer => {
                        ...
                        if ( tense === AuctionConstants.PAST ) {
                            ...
                            if ( counter > 2 ) {
                                NotificationService.warn(
                                    "<h3>STATUS:</h3><hr>" + TranslationsAo.auctions.auctionMatchServerTime )
                                    .closeAfter( 3000 );
                            }
                            setTimeout( () => {
